...
public abstract class MicroService implements Runnable {
    ...
    private Map<Class<? extends Message>, Callback<Message>> callbackMap = new HashMap<>();
    ...
    protected final <T, E extends Event<T>> void subscribeEvent(Class<E> type, Callback<E> callback) {
        ...
        this.callbackMap.put(type, (Message message) -> callback.call((E) message));
    }
    ...
    protected final <B extends Broadcast> void subscribeBroadcast(Class<B> type, Callback<B> callback) {
        ...
        this.callbackMap.put(type, (Message message) -> callback.call((B) message));
    }
    ...
    protected final <T> void complete(Event<T> e, T result) {
        ((Future<T>) e.getFuture()).resolve(result);
    }
    ...
    public final void run() {
        ...
        while (!terminated) {
            ...
            this.callbackMap.get(message.getClass()).call(message);
        }
